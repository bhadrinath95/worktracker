...
SECRET_KEY = 'django-insecure-1^zci@uf2dfok^=ftc%!e3uf@-i5hz8y-%=ugb7rok!qqf&j9j'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tracker.context_processors.active_notifications',
            ],
        },
    },
]
...
GROQ_API_KEY_11 = env.get("GROQ_API_KEY11")
GROQ_API_KEY_12 = env.get("GROQ_API_KEY12")
GROQ_API_KEY_13 = env.get("GROQ_API_KEY13")
GROQ_API_KEY_14 = env.get("GROQ_API_KEY14")
GROQ_API_KEY_15 = env.get("GROQ_API_KEY15")
